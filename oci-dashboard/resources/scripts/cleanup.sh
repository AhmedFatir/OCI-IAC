...
(cd /root/resources/terraform && terraform destroy -auto-approve)

echo "Remove the terraform files..."
(cd /root/resources/terraform && rm -rf .terraform .terraform.lock.hcl terraform.tfstate terraform.tfstate.backup)
